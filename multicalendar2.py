...
from multicalendar_libs import convert2
...
if sys.version_info[0] > 2:
    ...
    def hijri_monthcalendar(y, m, adjust):
        date = convert2.Hijri(y,m,1, adjust)
...
class Calendar(inkex.EffectExtension):
    ...
    def add_arguments(self, pars):
        ...
        pars.add_argument(
            ...
            default="বৈশাখ, জ্যৈষ্ঠ, আষাঢ়, "
                    "শ্রাবণ, ভাদ্র, আশ্বিন, "
                    "কার্তিক, অগ্রহায়ন, পৌষ, "
                    "মাঘ, ফাল্গুন, চৈত্র",
    ...
    def validate_options(self):
        ...
        if len(self.options.month_names) != 12:
            ...
            self.options.hijri_month_names = ["বৈশাখ", "জ্যৈষ্ঠ", "আষাঢ়", "শ্রাবণ", "ভাদ্র", "আশ্বিন", "কার্তিক", "অগ্রহায়ন", "পৌষ", "মাঘ", "ফাল্গুন", "চৈত্র"]
        ...
        for week in cal:
            ...
            for day in week:
                if day == 0:
                    ...
                    weekcal.append(convert2.Hijri(y, m, day, adjust).to_gregorian())
            cal2.append(weekcal)
        return cal2
        ...
        for week in cal:
            ...
            for day in week:
                if day == 0:
                    ...
                    weekcal.append(convert2.Gregorian(y, m, day, self.options.adjust_hijri_date).to_hijri())
            cal2.append(weekcal)
        return cal2
